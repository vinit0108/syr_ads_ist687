...
# while partitioning the data, we need to balance the classification with respect to outcome
...
# yes, present_residence attribute might not be appropriate in predicting credit risk
